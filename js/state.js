...
const State = {
  ...
  diary: {
    ...
    planDetailIdx: null,  // null | number — открытый Screen 2 (Настройки упр. из плана)
  },
  orm: {
    active: false,
  ...
  settings: {
    ...
    focusMode: false,  // только вес+повторы в активной тренировке, без фото/тегов
  },
...
(function() {
  ...
  try { const fm = localStorage.getItem('sb_focus'); if (fm !== null) State.settings.focusMode = fm === '1'; } catch(e) {}
