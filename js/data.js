...
const MOVEMENT_TREE = {
  "Спина": [
    {
      ...
      types:[
        ...
        },
        {
          ...
          exId:"lat_pulldown",
          equips:["cable_wide","cable_narrow","cable_v","cable_single","cable_handle"],
          grips:null, accents:null,
        },
        {
          id:"pullover_t", name:"Тяга прямыми к поясу",
          exId:"cable_pullover",
          equipLabel:"РУКОЯТЬ",
          equips:["cable_straight","cable_rope"],
          grips:null, accents:null,
        },
      ]
    },
    {
      ...
      types:[
        ...
        },
        {
          ...
          exId:"seated_row",
          equipLabel: 'РУКОЯТЬ',
          equips:["cable_v","cable_wide","cable_single","cable_handle"],
  ...
  // ── ГРУДЬ: упрощённая архитектура — 1 шаг (снаряд) вместо 3 ──────────────
  // Акцент (угол скамьи) выбирается на Экране 2 (Настройки упражнения)
  "Грудь": [
    {
      id:"chest_main", name:"Грудь",
      typeLabel:"СНАРЯД",
      types:[
        { id:"chest_bar",   name:"Штанга",           exId:"bench_press",  fixedEquip:"barbell",      accents:null, equips:null },
        { id:"chest_db",    name:"Гантели",           exId:"bench_press",  fixedEquip:"dumbbells",    accents:null, equips:null },
        { id:"chest_hmr",   name:"Тренажёр / Хаммер", exId:"hammer_chest", fixedEquip:"hammer",       accents:null, equips:null },
        { id:"chest_cable", name:"Блоки / Кроссовер", exId:"cable_cross",  fixedEquip:"cable_single", accents:null, equips:null },
        { id:"chest_bw",    name:"Свой вес",          exId:"pushup",       fixedEquip:"bodyweight",   accents:null, equips:null },
      ]
    }
  ],
  "Бицепс": [
...
const EXERCISES = {
  ...
  "Спина": [
    ...
    {id:"lat_pulldown",  name:"Тяга блока вертикальная",  last:10, prev:{w:70,r:8,s:4},   equip:["cable_wide","cable_narrow","cable_v","cable_single","cable_handle"], grips:["wide","narrow","neutral","reverse"], notes:"Аналог подтягиваний на блоке"},
    {id:"seated_row",    name:"Тяга блока горизонтальная",last:45, prev:{w:65,r:10,s:3},  equip:["cable_v","cable_wide","cable_single","cable_handle"], grips:["narrow","medium","wide","neutral"],          notes:"V-рукоять — середина спины"},
    {id:"cable_pullover",name:"Тяга прямыми руками на блоке",last:0,prev:{w:25,r:12,s:3}, equip:["cable_straight","cable_rope"], grips:["straight","neutral"], notes:"Прямые руки · тяга сверху к поясу · изоляция широчайших без сгибания в локте"},
...
// ── Exercises with fixed/implicit grip — hide both gripType and gripWidth UI ──
const NO_GRIP_UI_EX_IDS = new Set(['tri_press_bar','tri_press_smith']);

// ── Chest angle → exId mapping (used by Plan Detail / Screen 2) ──
// Ключ: equip; значение: { upper, middle, lower } → { exId, name }
const CHEST_ANGLE_MAP = {
  barbell:      {
    upper:  { exId:'incline_press',  name:'Жим наклонный 45°' },
    middle: { exId:'bench_press',    name:'Жим лёжа' },
    lower:  { exId:'decline_press',  name:'Жим под углом вниз' },
  },
  dumbbells:    {
    upper:  { exId:'incline_press',  name:'Жим наклонный 45°' },
    middle: { exId:'bench_press',    name:'Жим лёжа' },
  ...
  hammer:       {
    upper:  { exId:'hammer_chest',   name:'Хаммер грудь' },
    middle: { exId:'hammer_chest',   name:'Хаммер грудь' },
  },
  cable_single: {
    upper:  { exId:'cable_cross',    name:'Кроссовер на блоке' },
    middle: { exId:'cable_cross',    name:'Кроссовер на блоке' },
    lower:  { exId:'cable_cross',    name:'Кроссовер на блоке' },
  },
  bodyweight:   {
    upper:  { exId:'pushup_elevated', name:'Отжимания ноги выше' },
    middle: { exId:'pushup',          name:'Отжимания от пола' },
  },
  dip_bars:     {
    upper:  { exId:'dips_chest',     name:'Отжимания на брусьях' },
    middle: { exId:'dips_chest',     name:'Отжимания на брусьях' },
  },
};
